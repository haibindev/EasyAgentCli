...
**AgentTerm** 让你在原生多窗格界面中并排运行 Claude Code、Gemini、Kimi 等 Agent，完整使用每个 CLI 的原生功能。需要外出时，一键开启**离开模式**——Agent 继续跑，你通过手机上的飞书、Discord 或 Telegram 随时监控、随时操作。
...
- 提交 [Bug 报告](https://github.com/haibindev/AgentTerm/issues) 或功能建议
- 给项目点 ⭐ Star 表示支持
