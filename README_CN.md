...
在可配置的网格布局中管理多个 Agent 会话，支持通过飞书、Discord 或 Openclaw 远程控制。
...
- 离开工位后通过**飞书 / Discord / Openclaw** 在手机上监控一切

## 预览

```
┌─────────────────────────────────────────────────────────────┐
│  [+Claude] [+Codex] [+Shell]   ⚙  布局[2×2]  🚶离开模式   │
├──────────────────────┬──────────────────────────────────────┤
...
│  On branch main...   │                                     │
├──────────────────────┴──────────────────────────────────────┤
│ Claude #1: 运行中  Codex #2: 等待确认  🔌 Bridge  3终端    │
└─────────────────────────────────────────────────────────────┘
```
